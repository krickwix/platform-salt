            ...
            "config":
                {
                    ...
                    'resource_manager_java_heapsize': '805306368',
        ...
        [
            {
                ...
                "config": {'dfs_name_dir_list': '/data0/nn',
                           ...
                           'namenode_java_heapsize': 805306368,
            ...
            },
            {
                ...
                "config": {'fs_checkpoint_dir_list': '/data0/snn',
                           ...
                           'max_log_backup_index': '2',
                           'max_log_size': '100',
                           'secondary_namenode_java_heapsize': '805306368',
        ...
        [
            {
                ...
                "config": {'hive_log_dir': '/var/log/pnda/hive',
                           'hive_metastore_java_heapsize': '805306368',
                           'log_directory_free_space_absolute_thresholds': '{"warning":4294967296,"critical":3221225472}',
                           'max_log_backup_index': '2',
                           'max_log_size': '100'}
            },
            {
                "type": "HIVESERVER2",
                "config": {'hive_log_dir': '/var/log/pnda/hive', 'hiveserver2_java_heapsize': '805306368',
                           'log_directory_free_space_absolute_thresholds': '{"warning":4294967296,"critical":3221225472}',
                           'max_log_backup_index': '2',
                           'max_log_size': '100'}
            },
...
IMPALA_CFG = {
    ...
    'role_cfg': [
        {'type': 'IMPALAD', 'config': {'impalad_memory_limit': '805306368',
